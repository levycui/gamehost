...
url = 'http://www.youxiwugui.com/gameconsole/requirementslist.aspx?platform=&sort=create'
getPageNum = 29
...
def getEvery(url):
    ...
    # print div
    spanList = div.find_all('div',class_='list_cover')
    # print spanList
    for li in spanList:
...
def getText(href):
    ...
    # print num+',',
    if num or hostclass or committime != '':
        df.write(num+'||',)
        # print hostclass+',',
        df.write(hostclass+'||',)
        # print committime+',',
...
def getURL():
    ...
    for i in range(1,(getPageNum+1)):
        url = 'http://www.youxiwugui.com/gameconsole/requirementslist.aspx?platform=&sort=create&page=' + str(i)
        # print url
        href = getEvery(url)
        for con in href:
            # print con
